...
## Part 3
Part 3 uses "flights_database.db" to interact with the full database and link different tables together using SQL queries with sqlite3. With the files for Part 3:
...
## Part 4
Part 4 uses "flights_database.db" for data wrangling, data cleaning, datetime conversion, consistency checks, and grouped summaries for later dashboard use. With the files for Part 4:
